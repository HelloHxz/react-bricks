...
class ScrollView extends React.Component {
  ...
  render() {
    ...
    if(outStyle.padding){
    	moveStyle.padding = outStyle.padding;
    	delete outStyle.padding;
    }
    if(outStyle.paddingLeft){
    	moveStyle.paddingLeft = outStyle.paddingLeft;
    	delete outStyle.paddingLeft;
    }
    if(outStyle.paddingRight){
    	moveStyle.paddingRight = outStyle.paddingRight;
    	delete outStyle.paddingRight;
    }
    if(outStyle.paddingBottom){
    	moveStyle.paddingBottom = outStyle.paddingBottom;
    	delete outStyle.paddingBottom;
    }
    if(outStyle.paddingTop){
    	moveStyle.paddingTop = outStyle.paddingTop;
    	delete outStyle.paddingTop;
    }
