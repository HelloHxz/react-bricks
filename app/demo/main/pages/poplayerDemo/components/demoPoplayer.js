...
class PoplayerManager extends React.Component {
  ...
  showOther(){
    this.props.poplayerDemoStore.popLayerConfig = {key:"other",dirction:"top"};
  }
  ...
  onBackLayerClick(){
     this.props.poplayerDemoStore.popLayerConfig = null;
  }
  ...
  render() {
    return (
      ...
      renderItem={
        ...
        }  config={this.props.poplayerDemoStore.popLayerConfig}/>
    );
  }
}
